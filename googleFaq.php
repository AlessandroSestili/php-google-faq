...
$lista = [
    [
        ...
        "answer" => '<p class="marginBottParagraph">
                    ...
                    anche che sia importante rispettare la decisione della Corte e ci stiamo adoperando per predisporre una procedura conforme alla legge.
                    <br>
                    </p>
                    <p class="marginBottParagraph">
    ...
    [
        ...
        "answer" => "   
                    ...
                    <p class=marginBottParagraph>
                        ...
                        efficiente per te. Spendiamo centinaia di milioni di dollari ogni anno per la sicurezza e ci avvaliamo di esperti di fama mondiale 
                        in materia di sicurezza dei dati per mantenere le tue informazioni al sicuro. Abbiamo inoltre sviluppato strumenti per la sicurezza e
                        la privacy di facile utilizzo come Google Dashboard, la verifica in due passaggi e Impostazioni annunci. Così, per quanto riguarda 
                    ...
                    <p class=marginBottParagraph>
                        ...
                        Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel 
                        <a class=colorBlue href=https://www.google.com/safetycenter/ target=_blank>Centro Google per la sicurezza online.</a>
                        <br>
                    </p>
                    <p class=marginBottParagraph>
                        <a class=colorBlue href= https://privacy.google.com/ target=_blank>
                            Scopri 
                        </a>
        ...
        Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
            ...
            <ol class=sortedList>
                <li class=listItem>
                    ...
                    informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti.
                    Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                
                    <ol type=a class=sortedList>
                        <li class=listItem>
            ...
            ",
        "subtitle" => [
            "questionSubtitle" => "Stabilire il paese associato al tuo account",

            "answerOfSubtitle" =>
                                "   
                                    <p class=marginBottParagraph>
                                    Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato.
                                    Per quanto riguarda gli account creati almeno un anno fa, 
                                    usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui
                                    hai trascorso più tempo nell'ultimo anno.
                                    <br>
                                    </p>
                                    ...
                                    Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere
                                    la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale
                                    (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. Contattaci se ritieni
                                    che il paese associato al tuo account sia sbagliato.
                                    </p>
                                ",
        ]
    ],
    [
        ...
        "answer" => "
                    <p class=marginBottParagraph>
                    I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori
                    di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di
                    ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web,
                    devi 
                    <a class=colorBlue href=https://support.google.com/websearch/answer/9109?hl=it target=_blank>
                    contattare il webmaster 
                    </a>
                    del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica.
                    ...
                    <a class=colorBlue href=https://support.google.com/legal/contact/lr_eudpa?product=websearch&hl=it target=_blank>
                    fai clic qui. 
                    </a>
                    Una volta che i contenuti saranno stati rimossi
                    e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google.
                    In caso di una richiesta di rimozione urgente, è inoltre possibile 
                    <a class=colorBlue href=https://support.google.com/websearch/troubleshooter/3111061?hl=it target=_blank>
    ...
    [
        ...
        "answer" => "
                    <p class=marginBottParagraph>
                    In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina
                    web di destinazione anche l'indirizzo Internet, o URL, della pagina dei risultati di ricerca sotto forma di 
                    <a class=colorBlue href=https://policies.google.com/privacy/key-terms#toc-terms-http target=_blank>
                    URL referrer. 
                    </a>
                    Talvolta,
                    l'URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito. Se utilizzi la ricerca SSL 
                    (la funzione di ricerca criptata di Google), nella maggior parte dei casi i termini di ricerca non vengono inviati come parte dell'URL 
                    negli URL referrer. Questo comportamento può fare eccezione, ad esempio se utilizzi alcuni browser meno diffusi. Ulteriori informazioni 
                    sulla ricerca SSL sono disponibili
                    <a class=colorBlue href=https://support.google.com/websearch/answer/173733 target=_blank>
                    qui. 
                    </a>
                    Le query di ricerca o le informazioni contenute nell'URL referrer potrebbero essere disponibili 
                    mediante Google Analytics o un'API (Application Programming Interface). Inoltre, gli inserzionisti potrebbero ricevere informazioni 
                    relative all' esatte parole chiave che hanno determinato il clic su un annuncio.
...
<body>
    ...
    <div class="wrapper">
        ...
        <?php
        foreach ($lista as $currentItem) {
            // var_dump($currentItem);
        ?>

            <h2>
                <?php echo $currentItem["question"] ?>
            </h2>
